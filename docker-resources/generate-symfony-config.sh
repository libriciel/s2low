...
HELIOS_FTP_PASSTRANS_MODE=${HELIOS_FTP_PASSTRANS_MODE:-false}
...
HELIOS_PASSTRANS_PASSTRANS_MODE=${HELIOS_PASSTRANS_PASSTRANS_MODE:-false}
HELIOS_PASSTRANS_LOGIN=${HELIOS_PASSTRANS_LOGIN:-helios}
HELIOS_PASSTRANS_PASSWORD=${HELIOS_PASSTRANS_PASSWORD:-helios}
