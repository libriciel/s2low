...
define("ACTES_OPENSTACK_AUTHENTICATION_URL_V3","${ACTES_OPENSTACK_AUTHENTICATION_URL_V3:-https://identity.fr1.cloudwatt.com/v2.0}");
...
define("HELIOS_OPENSTACK_AUTHENTICATION_URL_V3","${HELIOS_OPENSTACK_AUTHENTICATION_URL_V3:-https://identity.fr1.cloudwatt.com/v2.0}");
...
define("HELIOS_ACQUIT_OPENSTACK_AUTHENTICATION_URL_V3","${HELIOS_ACQUIT_OPENSTACK_AUTHENTICATION_URL_V3:-https://identity.fr1.cloudwatt.com/v2.0}");
...
define("HELIOS_RETOUR_OPENSTACK_AUTHENTICATION_URL_V3","${HELIOS_RETOUR_OPENSTACK_AUTHENTICATION_URL_V3:-https://identity.fr1.cloudwatt.com/v2.0}");
...
define("MAILSEC_OPENSTACK_AUTHENTICATION_URL_V3","${MAILSEC_OPENSTACK_AUTHENTICATION_URL_V3:-https://identity.fr1.cloudwatt.com/v2.0}");
