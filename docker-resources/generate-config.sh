...
define("HELIOS_FTP_P_APPLI", "${HELIOS_FTP_P_APPLI:-GHELPES2}");

define("HELIOS_FTP_SERVER","${HELIOS_FTP_SERVER:-ftp}");
define("HELIOS_FTP_PORT","${HELIOS_FTP_PORT:-21}");
define("HELIOS_FTP_PASSIVE_MODE", ${HELIOS_FTP_PASSIVE_MODE:-true});
define("HELIOS_FTP_CONNECTION_MODE", "${HELIOS_FTP_CONNECTION_MODE:-false}");
...
define("HELIOS_PASSTRANS_SERVER","${HELIOS_PASSTRANS_SERVER:-ftp}");
define("HELIOS_PASSTRANS_PORT","${HELIOS_PASSTRANS_PORT:-21}");
define("HELIOS_PASSTRANS_PASSIVE_MODE",${HELIOS_PASSTRANS_PASSIVE_MODE:-true});
define("HELIOS_PASSTRANS_CONNECTION_MODE","${HELIOS_PASSTRANS_CONNECTION_MODE:-false}");
define("HELIOS_PASSTRANS_LOGIN","${HELIOS_PASSTRANS_LOGIN:-helios-passtrans}");
define("HELIOS_PASSTRANS_PASSWORD","${HELIOS_PASSTRANS_PASSWORD:-helios-passtrans}");
define("HELIOS_PASSTRANS_SENDING_DESTINATION","${HELIOS_PASSTRANS_SENDING_DESTINATION:-/entree/}");
define("HELIOS_PASSTRANS_RESPONSE_SERVER_PATH","${HELIOS_PASSTRANS_RESPONSE_SERVER_PATH:-/sortie/}");
