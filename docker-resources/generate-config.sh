...
define("HELIOS_ACQUIT_OPENSTACK_AUTHENTICATION_URL_V2","${HELIOS_ACQUIT_OPENSTACK_AUTHENTICATION_URL_V2:-https://identity.fr1.cloudwatt.com/v2.0}");
...
define("HELIOS_RETOUR_OPENSTACK_AUTHENTICATION_URL_V2","${HELIOS_RETOUR_OPENSTACK_AUTHENTICATION_URL_V2:-https://identity.fr1.cloudwatt.com/v2.0}");
...
define("MAILSEC_OPENSTACK_AUTHENTICATION_URL_V2","${MAILSEC_OPENSTACK_AUTHENTICATION_URL_V2:-https://identity.fr1.cloudwatt.com/v2.0}");
