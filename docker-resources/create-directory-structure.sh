...
"/data/tdt-workspace/mail/upload" \
"/data/tdt-workspace/mail/orphelins" \
...
"/data/tdt-workspace/actes/uploaded_no_transaction" \
...
"/data/tdt-workspace/helios/acquit_orphelins" \
"/data/tdt-workspace/helios/retour_orphelins" \
