...
class VerifyPemCertificate
{
    ...
    public function checkCertificateWithOpenSSL(
        ...
        $this->checkForCrlRevocation($certificate_path, $date, $ca_path);
     ...
     */
    protected function checkForCrlRevocation(string $file, DateTime $dateTime, string $ca_path): void
    {
        ...
        if (file_exists($file_r0)) {
            ...
            // 2) vérifier que ce SN n'est pas présent dans la CRL
            // On ne vérifie pas
