...
<?php
/**
 * \class Layout Layout.class.php
 * \brief Classe pour la génération de mise en page
 * \author Jérôme Schell <j.schell@alternancesoft.com>
 * \date 17.02.2006
 * 
 *
 * Cette classe fournit des méthodes de base pour la génération de mise en page
 *
 * Modifications :
 * Auteur   Date       Commentaire
 * HTAN 07-01-2009 Ajout un fonction de simulateur de MIAT (pour ACT 1.4)
 */
