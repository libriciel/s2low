 ...
 * Contributeur : Jérôme Schell, 2006 
 *
...
<?php
/**
 * \class Authority Authority.class.php
 * \brief Classe de gestion des collectivtés
 ...
 *  JS   18.07.2006   Adaptation pour Tedetis
 */
...
class Authority extends DataObject {
  ...
  protected $dbFields = array( "name" => array( "descr" => "Nom", "type" => "isString", "mandatory" => true),
						 ...
						 "default_broadcast_email" => array( "descr" => "Adresse électronique de diffusion par défaut", "type" => "isString", "mandatory" => false),
