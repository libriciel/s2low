...
trait ActesUtilitiesTestTrait
{
    ...
    protected function createTransactionOfType(
        ...
        $sql = "INSERT INTO actes_envelopes(user_id,siren,department, submission_date) VALUES(113,'000000000','034', ?) returning ID";
    ...
    protected function createTransactionWithTmpDir(
        ...
        $transaction_id = $this->getActesTransactionsSQL()->create($lastEnveloppeId, $status, 113, 1);
    ...
    {
        $sql = "SELECT id FROM actes_envelopes WHERE user_id = 113 AND siren='000000000'";
