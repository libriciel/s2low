...
class AuthentificationTest extends S2lowIntegrationTestCase
{
    ...
    public function testAuthenticate()
    {
        ...
        $this->assertEquals(113, $authentification->authenticate());
    }
    ...
    public function testManyCertLoginOk()
    {
        ...
        $this->assertEquals(150, $authentification->authenticate());
    }
    ...
    public function testManyCertLoginWithLogin()
    {
        ...
        $this->assertEquals(153, $authentification->authenticate());
    }
    ...
    public function testAuthenticationWithNounce(bool $convertLoginFromIso, string $login, string $encoding): void
    {
        ...
        $nounce = $nounceSQL->create($login, "alice", 102);
        ...
        $this->assertEquals(151, $authentification->authenticate());
    }
