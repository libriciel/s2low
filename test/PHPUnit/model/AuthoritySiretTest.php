...
class AuthoritySiretTest extends S2lowTestCase
{
    ...
    {
        $this->authoritySiret->add(101, self::SIRET_EXEMPLE);
        $siret_list = $this->authoritySiret->siretList(101);
    ...
    {
        $id = $this->authoritySiret->add(101, self::SIRET_EXEMPLE);
        $this->authoritySiret->del(101);
        $this->authoritySiret->del($id);
        $this->assertEmpty($this->authoritySiret->siretList(101));
    }
    ...
    public function testAuthorityList()
    {
        ...
        $this->assertEquals(101, $authority_list[0]['authority_id']);
    }
    ...
    public function testBlocked()
    {
        ...
        $blocked_list = $this->authoritySiret->siretListBlocked(101);
        $this->assertEquals(1, count($blocked_list));
        $this->assertEmpty($this->authoritySiret->authorityList(self::SIRET_EXEMPLE));
        $this->assertEquals(1, count($this->authoritySiret->siretList(101)));
    }
    ...
    public function testUnblocked()
    {
        ...
        $this->assertEmpty($this->authoritySiret->siretListBlocked(101));
        $this->assertNotEmpty($this->authoritySiret->authorityList(self::SIRET_EXEMPLE));
        $this->assertNotEmpty($this->authoritySiret->siretList(101));
    }
}
