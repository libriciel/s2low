...
class MessageAdminSQLTest extends S2lowTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->message_id = $this->messageAdminSQL->edit(0, "titre", self::MESSAGE_TEST, 113, MessageAdmin::NIVEAU_DANGER);
    }
    ...
    public function testEditExisting()
    {
        ...
        $this->messageAdminSQL->edit(0, "titre2", $message2, 113, MessageAdmin::NIVEAU_DANGER);
        $result = $this->messageAdminSQL->getAll(0, 10);
    ...
    {
        $message_id_2 = $this->messageAdminSQL->edit(0, "titre2", self::MESSAGE_TEST, 113, MessageAdmin::NIVEAU_DANGER);

        $this->messageAdminSQL->publier($this->message_id, 113);
        $this->messageAdminSQL->publier($message_id_2, 113);
    ...
    public function testEditPulishMessage()
    {
        ...
        $this->messageAdminSQL->edit($this->message_id, 'test', 'toto', 113, MessageAdmin::NIVEAU_DANGER);
    }

    public function testRetirer()
    {
        $this->messageAdminSQL->publier($this->message_id, 113);
        $this->messageAdminSQL->retirer($this->message_id, 113);
    ...
    {
        $this->messageAdminSQL->edit($this->message_id, "titre2", "toto", 113, MessageAdmin::NIVEAU_DANGER);
        $messageAdmin = $this->messageAdminSQL->getMessage($this->message_id);
