...
class HeliosSAEControllerTest extends S2lowIntegrationTestCase
{
    ...
    public function testSuperAdminOneTransactionChangeImpossible(): void
    {
        ...
        $transaction_id = $this->createTransaction(101, HeliosStatusSQL::POSTE);
    ...
    public function testSuperAdminOneTransactionChangePossible(): void
    {
        ...
        $transaction_id = $this->createTransaction(101, HeliosStatusSQL::STATUS_EN_ATTENTE_TRANMISSION_SAE);
    ...
    public function testArchOneTransactionWrongTransactionNumber(): void
    {
        ...
        $transaction_id = $this->createTransaction(101, HeliosStatusSQL::STATUS_EN_ATTENTE_TRANMISSION_SAE) + 1 ;
    ...
    public function testArchOneTransactionDifferentAuthorities(): void
    {
        ...
        $transaction_id = $this->createTransaction(102, HeliosStatusSQL::STATUS_EN_ATTENTE_TRANMISSION_SAE);
