...
class ActeTamponneTest extends S2lowTestCase {
	...
	public function testGetTampon(){
		...
		$acteTamponne = new ActeTamponne($actesTransactionsSQL,new PDFStampWrapper("","/var/www/s2low/public.ssl/custom/images/s2low-stamp.png"), $this->getObjectInstancier()->get(S2lowLogger::class));
