...
class ActesApiControllerTest extends S2lowIntegrationTestCase
{
    ...
    {
        $this->setUserWithRole(UserRole::Utilisateur);
        $this->expectOutputString("{\"status_id\":0,\"authority_id\":101,\"nb_transactions\":0}");
    ...
    public function testListActesWithActe(): void
    {
        ...
        static::assertStringContainsString(
            '{"status_id":"1","authority_id":"101","offset":"0","limit":"100","transactions":[{"id":"' . $transaction_id,
...
//        );
    ...
    {
        return '{"status_id":"' . $status . '","authority_id":"101","offset":"0","limit":"100","transactions":[]}';
    }
