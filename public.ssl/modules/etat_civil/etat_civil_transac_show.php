 ...
 * Contributeur : J��e Schell, Août 2006 
 *
 ...
 * \author J��e Schell <j.schell@alternancesoft.com>
 * \date 27.07.2006
 * 
 *
...
$html .= "<a href=\"" .WEBSITE_SSL. "/modules/etat_civil/etat_civil_download_file.php?id=" .$id. "\" title=\"T�l�charger le fichier\">".$trans->getFilenameForID($id)."</a> </h3>";
