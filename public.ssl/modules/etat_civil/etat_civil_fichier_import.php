...
if ($module->getParam("paper") == "on") {
  $_SESSION["error"] = "Mode &nbsp;papier&nbsp; actif. Acc�s interdit.";
...
$html .= "<div id=\"content\">\n";
$html .= "<h1>D�mat�rialisation de documents concernant l'�tat civil</h1>\n";
...
$html .= "Indiquez le fichier archive de l'enveloppe �importer (taille maximum 20Mo)&nbsp;:<br />\n";
...
$html .= "<h2>Teste (API) de r�cuperation du status du fichier � partir de la transaction</h2>\n";
