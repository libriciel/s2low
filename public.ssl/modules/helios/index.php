 ...
 *
 * Ce logiciel est régi par la licence CeCILL soumise au droit fran�ais et
 ...
 * seule une responsabilit� restreinte pèse sur l'auteur du programme,  le
 * titulaire des droits patrimoniaux et les concédants successifs.
 *
 * A cet r�gard  l'attention de l'utilisateur est attir�e sur les risques
 * associ�s au chargement,  � l'utilisation,  � la modification et/ou au
 * d�veloppement et � la reproduction du logiciel par l'utilisateur autant 
 * donn� sa sp�cificit� de logiciel libre, qui peut le rendre complexe � 
 * manipuler et qui le r�serve donc � des d�veloppeurs et des professionnels
 * avertis poss�dant  des  connaissances  informatiques approfondies.  Les
 * utilisateurs sont donc invit�s � charger  et  tester  l'ad�quation  du
 * logiciel � leurs besoins dans des conditions permettant d'assurer la
 * s�curit� de leurs sys�mes et ou de leurs donn�es et, plus g�n�ralement, 
 ...
 * Helios et permet de les modifier ou d'en cr�er de nouvelles
 *
 * Modifications :
...
function afficheWarning(){
  ...
  var msg = "Voulez-vous vraiment affecter les " + n + " transactions s�lectionn�s ?\\n";
...
//deja HELIOS!!!!
$html = "<div id=\"content\">\n";
$html .= "<h1>Helios - D�mat�rialisation de documents financiers</h1>\n";
...
$html .= "<td colspan=\"" . $colspan . "\"><a href=\"" . WEBSITE_SSL . "/modules/helios/index.php\" class=\"bouton\">Remise&nbsp;�&nbsp;z�ro</a></td>\n";
$html .= "</tr>\n";
...
if (!$me->isSuper() && $me->canEdit($module->get('name'))) {
  if ($module->getParam("paper") == "on") {
    $html .= "<p>Le syst�me est actuellement en mode &nbsp;papier&nbsp;. Dans ce mode il est impossible de cr�r de nouvelle transaction. Les transferts doivent se faire par les moyens classiques (non d�at�ialis�).</p>\n";
  } else {
...
$html.="<a href=\"".WEBSITE_SSL. "/modules/helios/helios_retour.php\" class=\"bouton\" title=\"afficher la liste des r�ponses re�ues\">R�ponse d'H�lios</a>\n";
  $html .= "</div>\n";
...
if (isset ($fstatus) && is_numeric($fstatus)) {
  if ($fstatus == "10") {
    ...
    //-1 = il y a des probl�me, just pour test dans plateform de ovh.
...
if (count($envelopes) > 0) {
 ...
 foreach ($envelopes as $envelope) {
      ...
      $html .= " <td><a href=\"" . WEBSITE_SSL . "/modules/helios/helios_transac_show.php?id=" .$envelope["id"]. "\" class=\"icon\"><img src=\"" . WEBSITE_SSL . "/custom/images/erreur.png\" alt=\"image_modif\" title=\"Afficher le d�ail\" /></a></td>\n";
      $html .= "</tr>\n";
