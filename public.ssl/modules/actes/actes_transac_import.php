...
$html .= "<form class=\"import-file-form\" action=\"" . Helpers::getLink("/modules/actes/actes_transac_submit.php\" method=\"post\" enctype=\"multipart/form-data\" onsubmit=\"javascript:if (validateForm('enveloppe', 'Fichier enveloppe', 'RisString')) { toggle_upload('form_progress', progress_bar); return true; } else { return false; }\">\n");
...
$html .= "</div>\n";
$html .= "</div>\n";
$html .= "<div id=\"form_progress\" class=\"form-group row\"><div class=\"col-md-2\"><button class=\"btn btn-primary\" type=\"submit\" value=\"\" />Importer l'enveloppe</button></div></div>\n";
$html .= "</form>\n";
$html .= "</div>\n";
$html .= "</div>\n";
$html .= "</div>\n";
