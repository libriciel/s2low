...
$batch_id = Helpers::getIntFromGet("id");
$myAuthority = new Authority($me->get("authority_id"));

$batch = new ActesBatch($batch_id);
$batch->init();
...
$html .= "<h2>Ajout de fichiers au lot</h1>\n";
$html .= "<p>Intitul&eacute; du lot : " . $batch->get("description") . "</p>";
$html .= "<p>Pr&eacutefixe num&eacutero interne : " . $batch->get("num_prefix") . "</p>";
$html .= "<p>Traiter le lot <a href='" . Helpers::getLink("modules/actes/actes_batch_show.php") . "?id=$batch_id'>$batch_id</a>";
