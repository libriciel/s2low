...
<?php
/**
 * \file actes_classification_fetch.php
 * \brief Script de récupération de la classification matières/sous-matières
 * \author Jérôme Schell <j.schell@alternancesoft.com>
 * \date 10.08.2006
 * 
 *
 * Cette page retourne le fichier xml de la classification matières/sous-matières
 * pour la collectivité de l'utilisateur courant
 *
 * Modifications :
