 ...
 * 
 *
 * Cette classe fournit des m�thodes de traiter les requete de base de donner et les objets de tableaux.
 * Modifications :
...
class MailPeer {
  ...
  /**
   * \bref: v�rifier une email adress est d�jas dans la tableau de annuaire
   * 
   * @param string $mail :adress qu'on va v�rifier
