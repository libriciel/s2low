 ...
 <h1> Mail - Système de mail sécurisé</h1>
  ...
  $(document).ready(function(){
      ...
      $( ".annuaire-autocomplete" )
        ...
        <form class="mail-form" action="index.php?command=send" method="post"  id="mailform" onSubmit="InsertFileNumber();return checkFormCreateMail();" enctype="multipart/form-data" autocomplete="off">
