...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
 ...
 <div id="header">
 <div id="home_header1">
  <img src="<?php echo WEBSITE ?>/custom/images/home_banner.jpg" alt="" width="1000" height="160" usemap="Map" />
  <map id="Map"><area shape="rect" alt="Bandeau" coords="0,120,900,180" href="<?php echo WEBSITE ?>"/></map>
 </div>
 <div id="home_header2"><img src="<?php echo WEBSITE ?>/custom/images/home_subbanner.jpg" alt="" width="900" height="80" /></div>
 </div>
 <div id="menu-area">
  <div id="menu">
   <div id="menu-header">
...
<div id="mention">
 ...
 <div id="mention_partenaires">
  ...
  <p class="home">
   <a class="icon" href="http://www.adullact.org/"><img src="<?php echo WEBSITE ?>/custom/images/logo_adullact_projet.jpg" alt="Logo ADULLACT" /></a>&nbsp;
   <a class="icon" href="http://www.alternancesoft.com/"><img src="<?php echo WEBSITE ?>/custom/images/logo_alternance.jpg" alt="Logo Alternance Soft" /></a>
  </p>
 </div>
</div>
</div>
