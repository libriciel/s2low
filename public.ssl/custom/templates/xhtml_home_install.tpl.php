...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo WEBSITE ?>/custom/styles/style.css" />
 ...
 <div id="home_header1">
  ...
  <map id="Map"><area shape="rect" alt="Bandeau" coords="0,95,900,120" href="<?php echo WEBSITE ?>"/></map>
 </div>
 </div>
 <?php echo $this->body ?>
 </body>
