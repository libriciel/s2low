/*
 *
 * FROM : https://github.com/mtkopone/zelect#ajax-loader-example
 *
 *
  zelect-0.0.9
...
(function ($) {
            ...
            if ($(this).parent().length === 0) {
                ...
                $search.keydown(function (e) {
                    switch (e.which) {
                        ...
                        case keys.enter: e.preventDefault(); return;
                    }
                })
    ...
    {
        var dummyRegexp = { test: function () {
            return true } }
        var options = $select.find('option').map(function () {
            return itemFromOption($(this)) }).get()
