...
$html .= "<h2>Actions</h2>\n";
$html .= "<a href=\"" . \S2lowLegacy\Class\Helpers\UrlHelper::getLink("/admin/groups/admin_group_edit.php\" class=\"btn btn-primary\">Ajouter un groupe</a>\n");
$html .= "<a href=\"" . \S2lowLegacy\Class\Helpers\UrlHelper::getLink("/admin/groups/list_groups.php\" class=\"btn btn-primary\">Liste des groupes</a>\n");
