...
if (isset($id)) {
    ...
    $module = $moduleSQL->getById($id);
    if ($module && $moduleSQL->delete($id)) {
        $msg = "Suppression du module " . $module->name . ". Résultat ok.";
        ...
        $msg = "Erreur lors de la tentative de suppression du module";
