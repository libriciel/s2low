...
if (! $me->isSuper() && $mod) {
  ...
  if (! $canUserEdit) {
	$_SESSION["error"] = "Impossible de modifier cet utilisateur. Acc�s refus�.";
...
$html .= " </tr>\n";
$html .= " <tr>\n";
$html .= "  <td class=\"td-register\">Mot de passe (� nouveau)*&nbsp;:</td>\n";
$html .= "  <td class=\"td-input\"><input type=\"password\" name=\"password2\" value=\"\" size=\"30\" maxlength=\"60\" /></td>\n";
$html .= " </tr>\n";
$html .= "<tr><td>*uniquement n�cessaire si deux utilisateurs ont le m�me certificat</td></tr>";

$html .= " <tr>\n";
$html .= "  <td class=\"td-register\">Adresse �lectronique&nbsp;:</td>\n";
...
$html .= " </tr>\n";
$html .= " <tr>\n";
$html .= "  <td class=\"td-register\">T�l�phone&nbsp;:</td>\n";
...
$html .= " </tr>\n";
$html .= " <tr>\n";
$html .= "  <td class=\"td-register\">�tat&nbsp;:</td>\n";
...
if ($me->isGroupAdminOrSuper()) {
  ...
  $html .= " <tr>\n";
  $html .= "  <td class=\"td-register\">Collectivit�&nbsp;:</td>\n";
  $html .= "  <td class=\"td-input\">\n";
...
$html .= " <tr> \n";
$html .= "  <td class=\"td-register\">R�le&nbsp;:</td>\n";
$html .= "  <td class=\"td-input\">\n";
...
if (! $me->isSuper()) {
  // Les admin simple et de groupe ne peut pas cr�er un super admin ni un admin de groupe
  $tmp = array();
...
// R�cup�ration des modules actifs globalement
$modules = Module::getActiveModulesList();

// R�cup�ration des modules authoris�s pour la collectivit�
$authModules = array();
if ($mod) {
  $authModules = Module::getModulesForAuthority($him->get("authority_id"));
} else {
  if ($me->isGroupAdminOrSuper()) {
	// On ne sait pas � l'avance � quelle collectivit� appartiendra l'utilisateur
...
$html .= "<h2>Autre r�le de l'utilisateur</h2>";
if (count($ids_cert) > 1){
	$html .= "<div class=\"data_table\">\n";
	...
	foreach($ids_cert as $id_other){
		...
		$he->init();
 		...
 		$html .= " <td>" . $he->get("login") . "</td>\n"; 		
  		...
  		$html .= " <td><a href=\"mailto:" .$he->get("email"). "\">" . $him->get("email") . "</a></td>\n";
...
if ($him->get('login')) {
	$html .="<a href='admin_user_edit.php?new_id=".($id?$id:$new_id)."'>Cr�er un nouveau r�le avec le m�me certificat </a>";
	if ($him->get('subject_dn')){
		$html .= "(".htmlspecialchars($him->get('subject_dn')) .")";	
	}
} else {
	$html .= "Si vous voulez cr�er un autre utilisateur a partir du m�me certificat, vous devez saisir le champ login";
}
