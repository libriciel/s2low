...
/**
 * \file logs_view.php
 * \brief Page d'affichage du journal d'�v�nements
 * \author J�r�me Schell <j.schell@alternancesoft.com>
 * \date 18.08.2006
 * 
 *
 * Cette page affiche les entr�es du journal concernant l'utilisateur 
 * connect�.
 *
 * Modifications :
...
$doc->setTitle("Tedetis : Journal d'�v�nements");

$doc->buildMenu($me);

$html = "<div id=\"content\">\n";
$html .= "<h1>Journal d'�v�nements";
...
$html .= "<td class=\"title\">S�v�rit�&nbsp;:</td>\n";
...
if ($me->isAdmin()) {
  ...
  } elseif ($me->isAuthorityAdmin()) { // Un admin d'une collectivit� ne voit forc�ment que les entr�es concernant sa collectivit�
...
$html .= "<h2>Entr�es du journal</h2>\n";

if (count($logEntries) > 0) {
  $html .= "<table cellpadding=\"3\" cellspacing=\"2\" class=\"logs\">";
  $html .= "<tr>\n";
  $html .= " <th class=\"data\">Date</th>\n";
  $html .= " <th class=\"data\">Cr�� par</th>\n";
  $html .= " <th class=\"data\">S�v�rit�</th>\n";
  ...
  foreach ($logEntries as $logEntry) {
	...
	$html .= " <td><a href=\"" . WEBSITE_SSL . "/common/logs_get_timestamp.php?id=" . $logEntry["id"] . "\" title=\"T�l�charger une archive contenant l'entr�e de journal n�" .$logEntry["id"] . " et sa signature\" class=\"icon\"><img src=\"" . WEBSITE_SSL . "/custom/images/timestamping_icon.png\" alt=\"timestamp\" /></a></td>\n";
	$html .= "</tr>\n";
  ...
  $html .= "Pas d'entr�e de journal correspondant au filtrage sp�cifi�.";
}
