...
$html .= "<li>Modules ACTES : possibilité d'ajouter la date d'affichage dans le tampon apposé par S²LOW ;</li>";
...
$html .= "<li>Administration : ajout d'une page d'administration des transactions HELIOS ; </li>";
$html .= "<li>Administration : contrôle renforcé sur les adresses mails ;</li>";
$html .= "</ul>";
...
$html .= "<ul>";
$html .= "<li>Module ACTES/HELIOS : système de versement global des transactions sur une période donnée par collectivité ;</li>";
...
$html .= "<li>Module ACTES : authentification par RGS* associée à un RGS** ;";
$html .= "<li>Module ACTES : nouvelle présentation du système d'authentification dans la fiche utilisateur ;";
$html .= "<li>Module ACTES : possibilité de verser par lot les actes à l'état validé ;";
$html .= "<li>Module ACTES : le trigramme et le quadrigramme sont désormais vérifiés par la partie PHP ;";
$html .= "<li>Module ACTES : l'administrateur de groupe ne voit plus les boutons Créer, Importer et Traitement par lot ;";
$html .= "<li>Module ACTES/HELIOS : S²LOW ordonne à Pastell de supprimer le document lorsque le versement s'est correctement déroulé ;";
$html .= "<li>Module HELIOS : ajout de la recherche sur la balise NomFic ;";
$html .= "<li>Module HELIOS : Notification aux administrateurs de la plate-forme lors d'un problème d'accès au FTP de la DGFiP ;";
$html .= "<li>Module HELIOS : Déplacement du fichier PES dans un dossier spécifique en cas d'erreur sur le fichier ;";
$html .= "<li>Module HELIOS : retour du bouton pour le versement par lot ;";
$html .= "<li>Module HELIOS : nouveau système de collecte des SIRET pour l'analyse des PES_RETOUR ;";
$html .= "<li>Module HELIOS : permettre de sélectionner plusieurs transactions ;";
$html .= "<li>Module HELIOS : les flux PES_ALLER sont signés techniquement par S²LOW, dans certains cas ;";
$html .= "<li>Module ACTES/HELIOS : changement d'id de transfert par identifiant Pastell ;";
$html .= "<li>Module HELIOS : l'analyse des fichiers par l'antivirus se fait, désormais, lors de l'analyse du PES ;";
$html .= "<li>Module HELIOS : versement des flux à l'état Refusé par le SAE ;";
$html .= "<li>Module ACTES : correction bug : il n'est plus possible de verser deux fois le même ACTES ;";
$html .= "<li>Module ACTES : correction bug : il n'est plus possible de créer un acte sans fournir le pdf principal ;";
...
$html .= "<li>Module Mails : correction bug ; sous IE, il n'était pas possible de saisir deux emails dans le même champ;";
$html .= "</ul>";
...
$html .= "<li>Module HELIOS : le système d'analyse et de télétransmission des flux PES a été scindé en deux parties ;";
...
$html .= "<li>Module ACTES : correction bug : les signatures des transactions n'étaient plus incluses dans le cadre de la soumission d'une enveloppe complète ;";
...
$html .= "<li>Module HELIOS : pour la signature en local, les PES sont signés au niveau bordereaux si ils ont des ID ;";
$html .= "</ul>";
...
$html .= "<li>Module ACTES : permettre à un administrateur de collectivité de verser au SAE ;";
$html .= "<li>Module ACTES : transmission de l'acte tamponné lors du versement au SAE ;";
...
$html .= "<li>Module ACTES : possibilité d'envoyer un PDF joint à un XML (acte budgétaire) ;";
...
$html .= "<li>Module HELIOS : refonte du système d'envoi des flux PES pour passer de JAVA à PHP ;";
...
$html .= "<li>Module ACTES : ajout d'un statut permettant de temporiser l'envoi d'un acte après sont dépôt sur le TdT;";
...
$html .= "<ul>";
$html .= "<li>Module ACTES : correction bug : la variable pdfgenerate n'était pas correctement réinitialisée. Cela entrainait une erreur sur le PDF joint aux notifications automatiques ;";
...
$html .= "<ul>";
$html .= "<li>Module ACTES : correction bug : les PDFs optimisés sont pris en compte pour apposer le cartouche/tampon dans les mails de notifications ;";
$html .= "<li>Module ACTES : correction bug : la supression des dossiers temporaires unzip doit être faite après avoir changé de répertoire courant pour éviter un NOTICE ;";
$html .= "<li>Module ACTES : correction bug : les fichiers avec l'extension .PDF sont tamponnés ;";
...
$html .= "<li>Module MAIL : Le corps du mail de notification envoyé aux destinataires a été reformulé suite aux demandes des collectivités ;";
$html .= "<li>Module MAIL : Le nombre de carcatères autorisés dans le carnet d adresses pour les noms des contacts est passé à 100 ;";
$html .= "<li>Module MAIL : Les champs \"Nom\" et \"Adresse mail\" sont protégés contre l'insertion de code ;";
$html .= "<li>Admnistration : Le nombre de caractères autorisés dans le champ adresse électronique de diffusion d information est passé à 2000 ;";
...
$html .= "<li>Module ACTES : correction bug : la suppression des fichiers temporaires entrainait un warning dans les logs";
...
$html .= "<li>Module HELIOS : correction bug : en cas d erreur lors de la transmis d un flux, un message indiquant le problème est fourni";
...
$html .= "<li>Module HELIOS : prise en compte des fichiers vide présents sur les serveurs de la DGFiP";
...
$html .= "<li>Module ACTES : Correction bug : Mails de notifications envoyés en double";
$html .= "<li>Module ACTES : Correction bug : Les caractères Microsoft Word sont acceptés";
...
$html .= "<li>Module MAIL : Correction bug : Les destinataires sont affichés par ordre alphabétique pour comparer plusieurs messages sur les mêmes listes";
...
$html .= "<li>Module ACTES : Le mail de notification d'accusé de réception inclu le bordereau d'acquitement";
...
$html .= "<li>Module ACTES : Les recherches ne sont plus sensibles à la casse";
$html .= "<li>Module ACTES : Les collectivités et groupes sont listés par ordre alphabétique";
$html .= "<li>Module ACTES : Un même certificat peut être utilisé par plusieurs utilisateurs via un login/mot de passe";
...
$html .= "<li>Module MAIL : Correction bug : les espaces entre les destinataires ne sont plus supprimés";
$html .= "<li>Module MAIL : Correction bug : les espaces dans les noms des fichiers ne sont plus tronqués";
$html .= "<li>Module MAIL : Correction bug : le nombre de destinataire n'est plus limité";
$html .= "<li>Module MAIL : Les statuts des messages sont plus détaillés";
$html .= "<li>Module MAIL : Chaque élément récupéré par un destinataire est horodaté";
$html .= "<li>Module MAIL : Le jour et l'heure où un destinataire a pris connaissance du message sont indiqués et horodatés";
$html .= "<li>Module MAIL : Nouvelle présentation des mails reçus";
...
$html .= "<li>Module MAIL : Il est possible de stipuler l'adresse mail émettrice pour l'ensemble des utilisateurs de la collectivité";
