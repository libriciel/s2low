...
$html .= "<li>Module HELIOS : correction bug : les administrateurs de groupes ne peuvent plus lister transactions des collectivités n'appartenant pas à leur groupe ;";
$html .= "<li>Module HELIOS : correction bug : la gestion des droits sur le module a été revue pour ne plus dépendre du module ACTES ;";
