...
CREATE UNIQUE INDEX actes_natures_pkey ON actes_natures USING btree (id)
CREATE UNIQUE INDEX actes_messages_reponses_pkey ON actes_messages_reponses USING btree (id)
CREATE UNIQUE INDEX actes_messages_status_pkey ON actes_messages_status USING btree (id)
CREATE UNIQUE INDEX helios_status_pkey ON helios_status USING btree (id)
CREATE UNIQUE INDEX helios_transactions_workflow_pkey ON helios_transactions_workflow USING btree (id)
...
CREATE UNIQUE INDEX helios_transactions_pkey ON helios_transactions USING btree (id)
...
CREATE UNIQUE INDEX modules_pkey ON modules USING btree (id)
CREATE UNIQUE INDEX modules_name_idx ON modules USING btree (name)
CREATE UNIQUE INDEX dia_transactions_pkey ON dia_transactions USING btree (id)
CREATE UNIQUE INDEX mail_included_file_pkey ON mail_included_file USING btree (id)
CREATE UNIQUE INDEX mail_errors_pkey ON mail_errors USING btree (id)
CREATE UNIQUE INDEX service_user_pkey ON service_user USING btree (id)
CREATE UNIQUE INDEX mail_message_emis_pkey ON mail_message_emis USING btree (id)
CREATE UNIQUE INDEX authority_departments_pkey ON authority_departments USING btree (id)
CREATE UNIQUE INDEX actes_transactions_workflow_pkey ON actes_transactions_workflow USING btree (id)
...
CREATE UNIQUE INDEX helios_transmission_windows_pkey ON helios_transmission_windows USING btree (id)
CREATE UNIQUE INDEX authority_group_siren_pkey ON authority_group_siren USING btree (id)
CREATE UNIQUE INDEX actes_transmission_windows_pkey ON actes_transmission_windows USING btree (id)
CREATE UNIQUE INDEX service_user_content_unique ON service_user_content USING btree (id_user, id_service)
CREATE UNIQUE INDEX authority_districts_pkey ON authority_districts USING btree (id)
CREATE UNIQUE INDEX dia_transactions_workflow_pkey ON dia_transactions_workflow USING btree (id)
CREATE UNIQUE INDEX modules_params_pkey ON modules_params USING btree (id)
CREATE UNIQUE INDEX mail_annuaire_mail_adresse ON mail_annuaire USING btree (mail_address, authority_id)
CREATE UNIQUE INDEX mail_annuaire_pkey ON mail_annuaire USING btree (id)
CREATE UNIQUE INDEX mail_transaction_pkey ON mail_transaction USING btree (id)
CREATE UNIQUE INDEX actes_batch_files_pkey ON actes_batch_files USING btree (id)
CREATE UNIQUE INDEX actes_transmission_window_hours_pkey ON actes_transmission_window_hours USING btree (id)
CREATE UNIQUE INDEX actes_classification_requests_pkey ON actes_classification_requests USING btree (id)
CREATE UNIQUE INDEX actes_messages_workflow_pkey ON actes_messages_workflow USING btree (id)
CREATE UNIQUE INDEX authority_siret_pkey ON authority_siret USING btree (id)
...
CREATE UNIQUE INDEX modules_authorities_pkey ON modules_authorities USING btree (id)
CREATE UNIQUE INDEX logs_historique_pkey ON logs_historique USING btree (id)
CREATE UNIQUE INDEX message_admin_pkey ON message_admin USING btree (id)
CREATE UNIQUE INDEX actes_envelopes_pkey ON actes_envelopes USING btree (id)
CREATE UNIQUE INDEX actes_status_pkey ON actes_status USING btree (id)
CREATE UNIQUE INDEX actes_batches_pkey ON actes_batches USING btree (id)
CREATE UNIQUE INDEX helios_transmission_window_hours_pkey ON helios_transmission_window_hours USING btree (id)
CREATE UNIQUE INDEX actes_included_files_pkey ON actes_included_files USING btree (id)
CREATE INDEX toto ON actes_included_files USING btree (transaction_id)
CREATE UNIQUE INDEX helios_retour_pkey ON helios_retour USING btree (id)
CREATE UNIQUE INDEX actes_classification_codes_pkey ON actes_classification_codes USING btree (id)
...
CREATE UNIQUE INDEX actes_messages_pkey ON actes_messages USING btree (id)
CREATE UNIQUE INDEX authority_groups_pkey ON authority_groups USING btree (id)
CREATE UNIQUE INDEX logs_request_pkey ON logs_request USING btree (id)
CREATE INDEX logs_request_user_id_demandeur_idx ON logs_request USING btree (user_id_demandeur)
CREATE UNIQUE INDEX actes_envelope_serials_pkey ON actes_envelope_serials USING btree (id)
CREATE UNIQUE INDEX authority_types_pkey ON authority_types USING btree (id)
CREATE INDEX at_user_id ON actes_transactions USING btree (user_id, last_status_id, id)
CREATE UNIQUE INDEX actes_transactions_pkey ON actes_transactions USING btree (id)
...
CREATE UNIQUE INDEX users_perms_pkey ON users_perms USING btree (id)
CREATE UNIQUE INDEX mail_groupe_unique ON mail_groupe USING btree (name, authority_id)
CREATE UNIQUE INDEX mail_groupe_pkey ON mail_groupe USING btree (id)
CREATE UNIQUE INDEX authorities_pkey ON authorities USING btree (id)
CREATE UNIQUE INDEX nounce_pkey ON nounce USING btree (id)
...
ALTER TABLE mail_annuaire ADD CONSTRAINT mail_annuaire_mail_adresse UNIQUE (mail_address,authority_id);
