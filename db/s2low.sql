...
CREATE UNIQUE INDEX mail_transaction_filename_id ON mail_transaction USING btree (fn_download, id);
CREATE INDEX mt_ui ON mail_transaction USING btree (user_id);
CREATE UNIQUE INDEX helios_retour_filename_id ON helios_retour USING btree (filename, id);
CREATE INDEX hr_id_is_incloud ON helios_retour USING btree (is_in_cloud, not_available, id);
...
CREATE UNIQUE INDEX helios_transactions_sha1_id ON helios_transactions USING btree (sha1, id);
CREATE UNIQUE INDEX helios_transactions_pes_acquit_filename_id ON helios_transactions USING btree (acquit_filename, id);
CREATE UNIQUE INDEX ht_pes_aquit_in_cloud ON helios_transactions USING btree (pes_acquit_is_in_cloud, pes_acquit_not_available, id);
CREATE UNIQUE INDEX helios_transactions_last_status_id ON helios_transactions USING btree (last_status_id, id);
...
CREATE INDEX ht_user_id ON helios_transactions USING btree (user_id, id DESC);
