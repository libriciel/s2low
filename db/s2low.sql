...
ALTER TABLE actes_status ADD PRIMARY KEY (id);
ALTER TABLE actes_natures ADD PRIMARY KEY (id);
...
ALTER TABLE actes_included_files ADD PRIMARY KEY (id);
...
ALTER TABLE actes_messages_reponses ADD PRIMARY KEY (id);
ALTER TABLE actes_messages_status ADD PRIMARY KEY (id);
ALTER TABLE helios_retour ADD CONSTRAINT helios_retour_authority_id FOREIGN KEY (authority_id) REFERENCES authorities(id);
ALTER TABLE helios_retour ADD PRIMARY KEY (id);
...
ALTER TABLE actes_transactions_workflow ADD PRIMARY KEY (id);
ALTER TABLE authority_departments ADD PRIMARY KEY (id);
ALTER TABLE helios_status ADD PRIMARY KEY (id);
ALTER TABLE helios_transmission_windows ADD PRIMARY KEY (id);
ALTER TABLE helios_transactions_workflow ADD PRIMARY KEY (id);
ALTER TABLE dia_transactions ADD PRIMARY KEY (id);
ALTER TABLE actes_transmission_windows ADD PRIMARY KEY (id);
...
ALTER TABLE dia_transactions_workflow ADD PRIMARY KEY (id);
ALTER TABLE authority_group_siren ADD PRIMARY KEY (id);
...
ALTER TABLE authority_types ADD PRIMARY KEY (id);
...
ALTER TABLE helios_transmission_window_hours ADD PRIMARY KEY (id);
...
ALTER TABLE authority_districts ADD PRIMARY KEY (id);
ALTER TABLE authority_groups ADD PRIMARY KEY (id);
ALTER TABLE mail_included_file ADD PRIMARY KEY (id);
ALTER TABLE mail_annuaire ADD CONSTRAINT mail_annuaire_mail_adresse UNIQUE (mail_address,authority_id);
ALTER TABLE mail_annuaire ADD PRIMARY KEY (id);
ALTER TABLE mail_errors ADD PRIMARY KEY (id);
...
ALTER TABLE users_perms ADD PRIMARY KEY (id);
...
ALTER TABLE modules_params ADD PRIMARY KEY (id);
...
ALTER TABLE mail_message_emis ADD PRIMARY KEY (id);
ALTER TABLE mail_transaction ADD PRIMARY KEY (id);
ALTER TABLE actes_batch_files ADD PRIMARY KEY (id);
...
ALTER TABLE actes_batches ADD PRIMARY KEY (id);
ALTER TABLE actes_batches ADD CONSTRAINT actes_batches_user_id_fk FOREIGN KEY (user_id) REFERENCES users(id);
ALTER TABLE actes_transmission_window_hours ADD PRIMARY KEY (id);
...
ALTER TABLE actes_classification_codes ADD PRIMARY KEY (id);
...
ALTER TABLE actes_classification_requests ADD PRIMARY KEY (id);
...
ALTER TABLE actes_envelope_serials ADD PRIMARY KEY (id);
...
ALTER TABLE mail_groupe ADD PRIMARY KEY (id);
...
ALTER TABLE actes_messages ADD PRIMARY KEY (id);
...
ALTER TABLE actes_messages_workflow ADD PRIMARY KEY (id);
ALTER TABLE actes_envelopes ADD PRIMARY KEY (id);
...
ALTER TABLE modules_authorities ADD PRIMARY KEY (id);
...
ALTER TABLE actes_transactions ADD PRIMARY KEY (id);
...
ALTER TABLE authority_siret ADD PRIMARY KEY (id);
...
ALTER TABLE logs_request ADD PRIMARY KEY (id);
...
ALTER TABLE message_admin ADD PRIMARY KEY (id);
