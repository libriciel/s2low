...
<p id="back-transaction-btn">
    <a class="btn btn-default" href='actes_transac_show.php?id=<?php echo $this->transaction_id ?>'>
        Retour à la transaction
    </a><br/>
</p>
<h2 id="validation_desc">Validation du fichier <?php echo $this->envelope_filename?></h2>


<?php if ($this->archive_is_valide) : ?>
    <div class="alert alert-success"><?php echo $this->validation_message?></div>
<?php else : ?>
    <div class="alert alert-danger"><?php echo $this->validation_message?></div>
<?php endif; ?>
...
<table class="table table-bordered" aria-describedby="validation_desc">
    ...
    <?php foreach ($this->error_xml as $i => $info) : ?>
        <tr>
...
<table class="table table-bordered">
    ...
    <?php foreach ($this->pades_result as $filename => $info) : ?>
        <tr>
