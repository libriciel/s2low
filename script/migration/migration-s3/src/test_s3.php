...
/**
 * test_s3.php - Outil de diagnostic S3
 *
 * Teste si une clé (key) existe dans les buckets S3, et affiche les métadonnées.
 *
 * Usage :
 *   php src/test_s3.php <key> -t <type>
 *
 * Exemples :
 *   php src/test_s3.php "212105340/002DU03122019/SLO-EACT--212105340--20191210-2.tar.gz" -t acte
 *   php src/test_s3.php "123456789/abcdef1234567890" -t pes_aller
 *   php src/test_s3.php "123456789/acquit.xml" -t pes_acquit
 *
...
if (!$typeAlias) {
    ...
    echo "\033[1mUsage:\033[0m php src/test_s3.php -t <type> <key>" . PHP_EOL;
    echo "       php src/test_s3.php -l (listing des buckets)" . PHP_EOL;
    exit(1);
}
