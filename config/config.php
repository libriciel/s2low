...
if (! defined("ACTES_OPENSTACK_AUTHENTICATION_URL_V2")) {
	define("ACTES_OPENSTACK_AUTHENTICATION_URL_V2", OPENSTACK_AUTHENTICATION_URL_V2);
}
...
if (! defined("HELIOS_OPENSTACK_AUTHENTICATION_URL_V2")) {
	define("HELIOS_OPENSTACK_AUTHENTICATION_URL_V2", OPENSTACK_AUTHENTICATION_URL_V2);
}
...
if (! defined("HELIOS_ACQUIT_OPENSTACK_AUTHENTICATION_URL_V2")) {
	define("HELIOS_ACQUIT_OPENSTACK_AUTHENTICATION_URL_V2", OPENSTACK_AUTHENTICATION_URL_V2);
}
...
if (! defined("HELIOS_RETOUR_OPENSTACK_AUTHENTICATION_URL_V2")) {
    define("HELIOS_RETOUR_OPENSTACK_AUTHENTICATION_URL_V2", OPENSTACK_AUTHENTICATION_URL_V2);
}
...
if (! defined("MAILSEC_OPENSTACK_AUTHENTICATION_URL_V2")) {
	define("MAILSEC_OPENSTACK_AUTHENTICATION_URL_V2", OPENSTACK_AUTHENTICATION_URL_V2);
}
